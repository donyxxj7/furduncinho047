...
export default function Home() {
  ...
  // 1. OTIMIZAÇÃO DE CÁLCULO: Memoização da data [cite: 2025-06-07]
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden selection:bg-purple-500/30">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-black/50 backdrop-blur-md">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 md:gap-3 min-w-0 shrink">
            {/* TÓPICO 3: Dimensões fixas para otimizar LCP */}
            <img
              src={APP_LOGO}
            ...
            {isAuthenticated ? (
              <>
                <Link href="/meus-ingressos">
                  <Button
                    variant="ghost"
                    className="text-gray-200 h-9 px-2 md:px-4 transition-colors hover:text-white"
                  >
                ...
                {user?.role === "admin" && (
                  <Link href="/admin">
                    <Button
                      variant="ghost"
                      className="text-purple-400 h-9 px-2 md:px-4 transition-colors hover:bg-purple-500/10"
                    >
                ...
                <Button
                  ...
                  className="text-gray-300 h-9 w-9 hover:text-red-400 transition-colors"
                >
              ...
              <div className="flex gap-1 md:gap-2">
                ...
                <Link href="/register">
                  <Button className="bg-white text-black font-bold h-8 md:h-10 text-[10px] md:text-sm px-2 md:px-4 hover:bg-gray-200 transition-colors">
                    Criar Conta
                  </Button>
                </Link>
              </div>
      ...
      <main>
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 z-10">
          <div className="container mx-auto max-w-5xl text-center">
            ...
            {/* TÓPICO 2: Contraste melhorado (gray-400 para gray-300) */}
            ...
            <div className="mb-12 scale-75 md:scale-100 min-h-[120px] md:min-h-[140px] flex items-center justify-center content-visibility-auto">
              <Countdown />
            </div>
            ...
            <Link href={isAuthenticated ? "/comprar" : "/login"}>
              <Button
                size="lg"
                className="h-14 px-8 text-lg font-bold bg-purple-600 rounded-full shadow-[0_0_30px_rgba(147,51,234,0.5)] transition-all hover:scale-105 active:scale-95"
              >
        ...
        <section className="py-12 md:py-20 relative z-10">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-purple-900/20 to-black border border-purple-500/30 p-6 md:p-8 rounded-2xl group transition-all">
      ...
      <footer className="py-8 border-t border-white/5 text-center text-gray-500 text-[10px] md:text-sm">
        <p>
